...
const productsSlice = createSlice({
  ...
  initialState: {
    products: [],
    selectedProduct: null, //store the details of single Products
    similarProducts: [],
    loading: false,
    error: null,
    filters: {
  ...
  extraReducers: (builder) => {
    builder
      ...
      // handle fetching single products detail
      ...
      // handle updating products detail
      ...
      .addCase(fetchSimilarProducts.fulfilled, (state, action) => {
        state.loading = false;
        state.similarProducts = action.payload; // <-- correct field
      })
